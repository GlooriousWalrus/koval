...
use crate::theme::{
        MenuBarVariant, MenuHeaderVariant,
...
pub fn Home() -> impl IntoView {
    ...
    view! {
        ...
        <main>
            <Menu />
            <div class="bg-gradient-to-tl from-purple-800 to-violet-500 text-white font-mono flex flex-col min-h-screen">                  
            <button 
                type="button" 
            ...
            >
                ...
                <div class="flex flex-row-reverse flex-wrap self-center my-auto mx-6 sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl">
                    <div
                    ...
                    >
                        <p 
                            class="text-3xl p-2.5 w-full text-center self-center"
                        >
                                {name}
                        </p>
                        <button 
                    ...
                    <div class="flex flex-col p-4 bg-purple-800 shadow-md hover:shadow-lg rounded-2xl m-auto" class:hidden=hide_flag>
                        <div class="flex items-center justify-between">
                            <div class="flex items-center">
